...
import com.example.linphones.BuildConfig
import com.example.linphones.LinphoneApplication.Companion.corePreferences
import com.example.linphones.R
import com.example.linphones.core.CorePreferences
import java.io.File
...
class CoreContext(val context: Context, coreConfig: Config) {
    ...
    val appVersion: String by lazy {
        ...
        val appBranch = context.getString(R.string.app_name)
...
//                    callErrorMessageResourceId.value = Event(message)
    ...
    fun createCallOverlay() {
        ...
        val overlay = LayoutInflater.from(context).inflate(R.layout.activity_main, null)
